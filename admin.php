    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-body">
              <h1 style="text-align: center;">Selamat Datang di "Trivia Bank"</h1>
              <h2 style="text-align: center;">Sebuah website Manajemen Soal & Jawaban</h2>
              <h2 style="text-align: center;">untuk aplikasi <b>Coding Trivia</b></h2>
            </div>
          </div>
