        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>  Edit Data Pemrograman C++ (Expert)
          </div>
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body card-block">
                  <form action="update-cppex.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <!-- ID -->
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                      <input type="text" id="disabled-input" class="form-control" name="id-cppex" placeholder="" readonly="" value="<?php if(isset($_GET['id_cppex'])){echo $_GET['id_cppex'];} ?>">
                    </div>
                    <div>
                      <?php
                      include '../../../connect.php';
                      $query = "SELECT * FROM cppex WHERE ID_CPPEX={$_GET['id_cppex']}";
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <textarea name="q-cppex" id="textarea-input" rows="9" placeholder="Question" class="form-control"><?php echo $hasil['Q_CPPEX'] ?></textarea>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c1-cppex" placeholder="Choice 1" class="form-control" value="<?php echo $hasil['C1_CPPEX'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c2-cppex" placeholder="Choice 2" class="form-control" value="<?php echo $hasil['C2_CPPEX'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c3-cppex" placeholder="Choice 3" class="form-control" value="<?php echo $hasil['C3_CPPEX'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c4-cppex" placeholder="Choice 4" class="form-control" value="<?php echo $hasil['C4_CPPEX'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="a-cppex" placeholder="Answer" class="form-control" value="<?php echo $hasil['A_CPPEX'] ?>">
