        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>  Edit Data Pemrograman C++ (Beginner)
          </div>
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body card-block">
                  <form action="update-cppez.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <!-- ID -->
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                      <input type="text" id="disabled-input" class="form-control" name="id-cppez" placeholder="" readonly="" value="<?php if(isset($_GET['id_cppez'])){echo $_GET['id_cppez'];} ?>">
                    </div>
                    <div>
                      <?php
                      include '../../../connect.php';
                      $query = "SELECT * FROM cppez WHERE ID_CPPEZ={$_GET['id_cppez']}";
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <textarea name="q-cppez" id="textarea-input" rows="9" placeholder="Question" class="form-control"><?php echo $hasil['Q_CPPEZ'] ?></textarea>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c1-cppez" placeholder="Choice 1" class="form-control" value="<?php echo $hasil['C1_CPPEZ'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c2-cppez" placeholder="Choice 2" class="form-control" value="<?php echo $hasil['C2_CPPEZ'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c3-cppez" placeholder="Choice 3" class="form-control" value="<?php echo $hasil['C3_CPPEZ'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c4-cppez" placeholder="Choice 4" class="form-control" value="<?php echo $hasil['C4_CPPEZ'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="a-cppez" placeholder="Answer" class="form-control" value="<?php echo $hasil['A_CPPEZ'] ?>">
