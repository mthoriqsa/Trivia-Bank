        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>  Edit Data Pemrograman C++ (Intermediate)
          </div>
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body card-block">
                  <form action="update-cppin.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <!-- ID -->
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                      <input type="text" id="disabled-input" class="form-control" name="id-cppin" placeholder="" readonly="" value="<?php if(isset($_GET['id_cppin'])){echo $_GET['id_cppin'];} ?>">
                    </div>
                    <div>
                      <?php
                      include '../../../connect.php';
                      $query = "SELECT * FROM cppin WHERE ID_CPPIN={$_GET['id_cppin']}";
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <textarea name="q-cppin" id="textarea-input" rows="9" placeholder="Question" class="form-control"><?php echo $hasil['Q_CPPIN'] ?></textarea>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c1-cppin" placeholder="Choice 1" class="form-control" value="<?php echo $hasil['C1_CPPIN'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c2-cppin" placeholder="Choice 2" class="form-control" value="<?php echo $hasil['C2_CPPIN'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c3-cppin" placeholder="Choice 3" class="form-control" value="<?php echo $hasil['C3_CPPIN'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c4-cppin" placeholder="Choice 4" class="form-control" value="<?php echo $hasil['C4_CPPIN'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="a-cppin" placeholder="Answer" class="form-control" value="<?php echo $hasil['A_CPPIN'] ?>">
