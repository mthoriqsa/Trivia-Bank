      ...
      <ul class="sidebar navbar-nav">
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                <a class="dropdown-item" href="../../../databases/algo/ez/data-algoin.php">Beginner</a>
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>  Edit Data Algoritma (Intermediate)
          </div>
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body card-block">
                  <form action="update-algoin.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <!-- ID -->
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                      <input type="text" id="disabled-input" class="form-control" name="id-algoin" placeholder="" readonly="" value="<?php if(isset($_GET['id_algoin'])){echo $_GET['id_algoin'];} ?>">
                    </div>
                    <div>
                      <?php
                      include '../../../connect.php';
                      $query = "SELECT * FROM algoin WHERE ID_ALGOIN={$_GET['id_algoin']}";
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <textarea name="q-algoin" id="textarea-input" rows="9" placeholder="Question" class="form-control"><?php echo $hasil['Q_ALGOIN'] ?></textarea>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c1-algoin" placeholder="Choice 1" class="form-control" value="<?php echo $hasil['C1_ALGOIN'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c2-algoin" placeholder="Choice 2" class="form-control" value="<?php echo $hasil['C2_ALGOIN'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c3-algoin" placeholder="Choice 3" class="form-control" value="<?php echo $hasil['C3_ALGOIN'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c4-algoin" placeholder="Choice 4" class="form-control" value="<?php echo $hasil['C4_ALGOIN'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="a-algoin" placeholder="Answer" class="form-control" value="<?php echo $hasil['A_ALGOIN'] ?>">
