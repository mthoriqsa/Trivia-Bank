        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>  Edit Data Algoritma (Expert)
          </div>
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body card-block">
                  <form action="update-algoex.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <!-- ID -->
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                      <input type="text" id="disabled-input" class="form-control" name="id-algoex" placeholder="" readonly="" value="<?php if(isset($_GET['id_algoex'])){echo $_GET['id_algoex'];} ?>">
                    </div>
                    <div>
                      <?php
                      include '../../../connect.php';
                      $query = "SELECT * FROM algoex WHERE ID_ALGOEX={$_GET['id_algoex']}";
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <textarea name="q-algoex" id="textarea-input" rows="9" placeholder="Question" class="form-control"><?php echo $hasil['Q_ALGOEX'] ?></textarea>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c1-algoex" placeholder="Choice 1" class="form-control" value="<?php echo $hasil['C1_ALGOEX'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c2-algoex" placeholder="Choice 2" class="form-control" value="<?php echo $hasil['C2_ALGOEX'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c3-algoex" placeholder="Choice 3" class="form-control" value="<?php echo $hasil['C3_ALGOEX'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c4-algoex" placeholder="Choice 4" class="form-control" value="<?php echo $hasil['C4_ALGOEX'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="a-algoex" placeholder="Answer" class="form-control" value="<?php echo $hasil['A_ALGOEX'] ?>">
