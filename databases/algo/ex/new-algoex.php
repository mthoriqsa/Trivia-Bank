        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>  Tambah Data Algoritma (Expert)
          </div>
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body card-block">
                  <form action="add-algoex.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <!-- Q -->
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <textarea name="q-algoex" id="textarea-input" rows="9" placeholder="Question" class="form-control" required></textarea>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c1-algoex" placeholder="Choice 1" class="form-control" required>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c2-algoex" placeholder="Choice 2" class="form-control" required>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c3-algoex" placeholder="Choice 3" class="form-control" required>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c4-algoex" placeholder="Choice 4" class="form-control" required>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="a-algoex" placeholder="Answer" class="form-control" required>
