        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>  Edit Data Algoritma (Beginner)
          </div>
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body card-block">
                  <form action="update-algoez.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <!-- ID -->
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                      <input type="text" id="disabled-input" class="form-control" name="id-algoez" placeholder="" readonly="" value="<?php if(isset($_GET['id_algoez'])){echo $_GET['id_algoez'];} ?>">
                    </div>
                    <div>
                      <?php
                      include '../../../connect.php';
                      $query = "SELECT * FROM algoez WHERE ID_ALGOEZ={$_GET['id_algoez']}";
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <textarea name="q-algoez" id="textarea-input" rows="9" placeholder="Question" class="form-control"><?php echo $hasil['Q_ALGOEZ'] ?></textarea>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c1-algoez" placeholder="Choice 1" class="form-control" value="<?php echo $hasil['C1_ALGOEZ'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c2-algoez" placeholder="Choice 2" class="form-control" value="<?php echo $hasil['C2_ALGOEZ'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c3-algoez" placeholder="Choice 3" class="form-control" value="<?php echo $hasil['C3_ALGOEZ'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c4-algoez" placeholder="Choice 4" class="form-control" value="<?php echo $hasil['C4_ALGOEZ'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="a-algoez" placeholder="Answer" class="form-control" value="<?php echo $hasil['A_ALGOEZ'] ?>">
