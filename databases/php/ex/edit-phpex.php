        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>  Edit Data Pemrograman Web (Expert)
          </div>
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body card-block">
                  <form action="update-phpex.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <!-- ID -->
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                      <input type="text" id="disabled-input" class="form-control" name="id-phpex" placeholder="" readonly="" value="<?php if(isset($_GET['id_phpex'])){echo $_GET['id_phpex'];} ?>">
                    </div>
                    <div>
                      <?php
                      include '../../../connect.php';
                      $query = "SELECT * FROM phpex WHERE ID_PHPEX={$_GET['id_phpex']}";
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <textarea name="q-phpex" id="textarea-input" rows="9" placeholder="Question" class="form-control"><?php echo $hasil['Q_PHPEX'] ?></textarea>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c1-phpex" placeholder="Choice 1" class="form-control" value="<?php echo $hasil['C1_PHPEX'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c2-phpex" placeholder="Choice 2" class="form-control" value="<?php echo $hasil['C2_PHPEX'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c3-phpex" placeholder="Choice 3" class="form-control" value="<?php echo $hasil['C3_PHPEX'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c4-phpex" placeholder="Choice 4" class="form-control" value="<?php echo $hasil['C4_PHPEX'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="a-phpex" placeholder="Answer" class="form-control" value="<?php echo $hasil['A_PHPEX'] ?>">
