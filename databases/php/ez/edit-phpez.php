        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>  Edit Data Pemrograman PHP (Beginner)
          </div>
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body card-block">
                  <form action="update-phpez.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <!-- ID -->
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                      <input type="text" id="disabled-input" class="form-control" name="id-phpez" placeholder="" readonly="" value="<?php if(isset($_GET['id_phpez'])){echo $_GET['id_phpez'];} ?>">
                    </div>
                    <div>
                      <?php
                      include '../../../connect.php';
                      $query = "SELECT * FROM phpez WHERE ID_PHPEZ={$_GET['id_phpez']}";
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <textarea name="q-phpez" id="textarea-input" rows="9" placeholder="Question" class="form-control"><?php echo $hasil['Q_PHPEZ'] ?></textarea>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c1-phpez" placeholder="Choice 1" class="form-control" value="<?php echo $hasil['C1_PHPEZ'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c2-phpez" placeholder="Choice 2" class="form-control" value="<?php echo $hasil['C2_PHPEZ'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c3-phpez" placeholder="Choice 3" class="form-control" value="<?php echo $hasil['C3_PHPEZ'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c4-phpez" placeholder="Choice 4" class="form-control" value="<?php echo $hasil['C4_PHPEZ'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="a-phpez" placeholder="Answer" class="form-control" value="<?php echo $hasil['A_PHPEZ'] ?>">
