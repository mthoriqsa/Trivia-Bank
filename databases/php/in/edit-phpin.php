        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>  Edit Data Pemrograman Web (Intermediate)
          </div>
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body card-block">
                  <form action="update-phpin.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <!-- ID -->
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                      <input type="text" id="disabled-input" class="form-control" name="id-phpin" placeholder="" readonly="" value="<?php if(isset($_GET['id_phpin'])){echo $_GET['id_phpin'];} ?>">
                    </div>
                    <div>
                      <?php
                      include '../../../connect.php';
                      $query = "SELECT * FROM phpin WHERE ID_PHPIN={$_GET['id_phpin']}";
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <textarea name="q-phpin" id="textarea-input" rows="9" placeholder="Question" class="form-control"><?php echo $hasil['Q_PHPIN'] ?></textarea>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c1-phpin" placeholder="Choice 1" class="form-control" value="<?php echo $hasil['C1_PHPIN'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c2-phpin" placeholder="Choice 2" class="form-control" value="<?php echo $hasil['C2_PHPIN'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c3-phpin" placeholder="Choice 3" class="form-control" value="<?php echo $hasil['C3_PHPIN'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c4-phpin" placeholder="Choice 4" class="form-control" value="<?php echo $hasil['C4_PHPIN'] ?>">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="a-phpin" placeholder="Answer" class="form-control" value="<?php echo $hasil['A_PHPIN'] ?>">
