        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>  Tambah Data Pemrograman Web (Intermediate)
          </div>
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body card-block">
                  <form action="add-phpin.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <!-- Q -->
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <textarea name="q-phpin" id="textarea-input" rows="9" placeholder="Question" class="form-control"></textarea>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c1-phpin" placeholder="Choice 1" class="form-control" required>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c2-phpin" placeholder="Choice 2" class="form-control" required>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c3-phpin" placeholder="Choice 3" class="form-control" required>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="c4-phpin" placeholder="Choice 4" class="form-control" required>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="a-phpin" placeholder="Answer" class="form-control" required>
